...
export const KeywordComboRow: React.FC<KeywordComboRowProps> = ({ combo, index, isSelected, visibleColumns, density = 'comfortable', metadata, rankingData, rankingsLoading, popularityData, popularityLoading }) => {
  ...
  return (
    <>
      ...
      `}>
        {/* Row Number */}
        <TableCell className="w-[40px] min-w-[40px] max-w-[40px] px-0 text-center sticky left-0 z-10 bg-black/90 backdrop-blur-md">
        ...
        {/* Selection Checkbox */}
        <TableCell className="w-[40px] min-w-[40px] max-w-[40px] px-0 text-center sticky left-[40px] z-10 bg-black/90 backdrop-blur-md border-r border-orange-500/20">
