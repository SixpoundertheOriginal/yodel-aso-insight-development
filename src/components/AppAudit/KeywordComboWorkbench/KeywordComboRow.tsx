...
export const KeywordComboRow: React.FC<KeywordComboRowProps> = ({ combo, index, isSelected, visibleColumns, density = 'comfortable', metadata, rankingData, rankingsLoading, popularityData, popularityLoading }) => {
  ...
  return (
    <>
      ...
      `}>
        {/* Row Number */}
        <TableCell className="w-[48px] min-w-[48px] max-w-[48px] px-0 text-center sticky left-0 z-10 bg-black/90 backdrop-blur-md">
        ...
        {/* Selection Checkbox */}
        <TableCell className="w-[48px] min-w-[48px] max-w-[48px] px-0 text-center sticky left-[48px] z-10 bg-black/90 backdrop-blur-md border-r border-orange-500/20">
