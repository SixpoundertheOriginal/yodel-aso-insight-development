...
import { TieredConfirmationScreen } from './TieredConfirmation';
                      ...
                      <EntityIntelligenceAnalyzer
                        ...
                        onIntelligenceGenerated={(intelligence) => {
                          const formatted: EntityIntelligence = {
                            ...
                            competitors: intelligence.competitors?.map((comp: any) => typeof comp === 'string' ? comp : comp.name) || [],
