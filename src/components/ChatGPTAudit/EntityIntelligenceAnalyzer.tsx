...
import { Brain, Target, Users, Trophy, Zap, AlertCircle, Building, Globe } from 'lucide-react';
...
export const EntityIntelligenceAnalyzer: React.FC<EntityIntelligenceAnalyzerProps> = ({
  ...
  if (!intelligence) {
    return <BrandedLoadingSpinner message="Entity Intelligence Analysis" description={analysisStep} />;
  }
