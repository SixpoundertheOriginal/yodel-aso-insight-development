...
export const FEATURE_CATEGORIES = {
  ...
  GROWTH_ACCELERATORS: {
    ...
    features: ['keyword_intelligence', 'competitive_intelligence', 'competitor_overview', 'creative_review', 'app_discovery', 'aso_chat', 'market_intelligence', 'reviews_public_rss_enabled', 'creative_analysis', 'keyword_rank_tracking', 'visibility_optimizer']
  },
  CONTROL_CENTER: {
    name: 'Control Center',
