  ...
  const onSubmit = async (data: UpdatePasswordFormValues) => {
    if (!user) {
      toast({
        ...
        description: 'Please start from the password recovery email.',
        variant: 'destructive',
      });
        ...
        <Card className="bg-zinc-900/50 border-zinc-800 backdrop-blur-sm max-w-md">
          <CardContent className="pt-6">
            <Alert variant="destructive">
              ...
              <AlertDescription>
                Session expired. Please request a new password recovery email.
              </AlertDescription>
            </Alert>
            <Button 
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="bg-zinc-900/50 border-zinc-800 backdrop-blur-sm">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-foreground">Update Password</CardTitle>
