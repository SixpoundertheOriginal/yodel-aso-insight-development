...
console.log('\n=== Restricting Stephen to ASO AI Hub Only ===\n');

// Features Stephen needs for ASO AI Hub access
const REQUIRED_FEATURES = [
  'app_core_access',  // Basic app access
...
console.log(`\n🚫 Disabling ${featuresToDisable.length} features:`, featuresToDisable);
